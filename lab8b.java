...
public class lab8b {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("The following numbers were duplicated in the Array list:" + dups(userNumbers));
	...
	public static ArrayList<Integer> dups(ArrayList<Integer> userNumbers){
		ArrayList<Integer> duplicate = new ArrayList<Integer>();
		for(int i=0; i <userNumbers.size(); i++) {
			if (userNumbers.subList(i+1, userNumbers.size()).contains(userNumbers.get(i))) {
				if (!duplicate.contains(userNumbers.get(i))) {
					duplicate.add(userNumbers.get(i));
				}
